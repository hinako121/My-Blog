<template>
  <div>
    ...
    <div style="border:1px solid var(--border);border-radius:var(--radius-sm);margin-bottom:16px" ref="editorRef"></div>
...
import { createPost, updatePost, getPost, uploadMedia } from '../../api'
...
onMounted(async () => {
  ...
  // Configure editor with custom image/video upload
  editor = createEditor({
